...
PLANS = {
    "TRIAL": Plan(
        ...
        0,
        1,
        "Один быстрый отчет по ссылке, чтобы клиент увидел слабые места сайта и понял ценность бота.",
        "первый контакт и прогрев к оплате",
        (
            "1 отчет по ссылке",
            "оценка готовности сайта к заявкам",
            "видимые проблемы сайта, CTA и формы",
            "демо плана действий без регулярного мониторинга",
        ),
    ),
    "START": Plan(
        "START",
        ...
        (
            "личный кабинет и Telegram-синхронизация",
